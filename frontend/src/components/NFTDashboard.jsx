...
export default function NFTDashboard() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      {loading ? (
          <p className="text-center text-gray-500 py-12 italic font-serif">Loading badges...</p>
      ) : nfts.length > 0 ? (
        ...
        <div className="text-center py-16 bg-gray-50 rounded-lg border-2 border-dashed border-black">
